  ...
  const featuresData: Feature[] = [   
    {
      ...
      title: t('crmfeatures.1Title'),
      description: t('crmfeatures.1Description'),
    }, 
    {
      id: 2,
      icon: "/images/icon/undraw_active.svg",
      title: t('crmfeatures.2Title'),
      description: t('crmfeatures.2Description'),
     },   
     {
      id: 3,
      icon: "/images/icon/undraw_ecom.svg",
      title: t('crmfeatures.3Title'),
      description: t('crmfeatures.3Description'),
    }, 
    // {
    //   id: 4,
