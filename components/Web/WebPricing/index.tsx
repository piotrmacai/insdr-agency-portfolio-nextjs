      ...
      <section className="pt-15 pb-20 lg:pb-25 xl:pb-30">
        <div className="mx-auto max-w-c-1315 px-4 md:px-8 xl:px-0">
          <div className="animate_top text-center mx-auto">
            <SectionHeader
              headerInfo={{
                title: t('webpricing.title'),
                subtitle: t('webpricing.subtitle'),
                description: t('webpricing.description'),
              }}
            />
          </div>
        </div>
          ...
          <div className="flex flex-wrap lg:flex-nowrap justify-center gap-7.5 xl:gap-12.5">
            ...
            <div className="animate_top md:w-[45%] lg:w-1/3 group relative bg-white dark:bg-blacksection rounded-lg shadow-solid-10 dark:shadow-none border border-stroke dark:border-strokedark p-7.5 xl:p-12.5">
              <h3 className="text-black dark:text-white font-bold text-2xl xl:text-3xl mb-2.5">
                {t('webpricing.landing.title')}
              </h3>
              <p className="mb-6">{t('webpricing.landing.description')}</p>
              
              <div className="flex gap-4 mb-6">
                <div className="w-1/2 bg-gray-2 dark:bg-black rounded-lg p-4">
                  <h4 className="font-semibold text-black dark:text-white mb-2">
                    {t('webpricing.landing.theme.title')}
                  </h4>
                  <p className="text-primary font-bold text-lg">{t('webpricing.landing.pricelandingtheme')}</p>
                </div>
                <div className="w-1/2 bg-meta/5 rounded-lg p-4">
                  <h4 className="font-semibold text-black dark:text-white mb-2">
                    {t('webpricing.landing.custom.title')}
                  </h4>
                  <p className="text-primary font-bold text-lg">{t('webpricing.landing.pricelandingcustom')}</p>
                </div>
              </div>
...
<div className="border-t border-stroke dark:border-strokedark mt-6 pt-6 pb-8">
  <h4 className="font-semibold text-black dark:text-white mb-4">
    {t('webpricing.landing.features.title')}
  </h4>
  <ul className="space-y-3">
    {(t('webpricing.landing.features.list', { returnObjects: true }) as string[]).map((feature, index) => (
      <li key={index} className="flex items-start gap-3 text-black dark:text-manatee">
        ...
        {feature}
            ...
            <div className="animate_top md:w-[45%] lg:w-1/3 group relative bg-white dark:bg-blacksection rounded-lg shadow-solid-10 dark:shadow-none border border-stroke dark:border-strokedark p-7.5 xl:p-12.5">
              <h3 className="text-black dark:text-white font-bold text-2xl xl:text-3xl mb-2.5">
                {t('webpricing.business.title')}
              </h3>
              <p className="mb-6">{t('webpricing.business.description')}</p>
              
              <div className="flex gap-4 mb-6">
                <div className="w-1/2 bg-gray-2 dark:bg-black rounded-lg p-4">
                  <h4 className="font-semibold text-black dark:text-white mb-2">
                    {t('webpricing.business.theme.title')}
                  </h4>
                  <p className="text-primary font-bold text-lg">{t('webpricing.business.pricebstheme')}</p>
                </div>
                <div className="w-1/2 bg-meta/5 rounded-lg p-4">
                  <h4 className="font-semibold text-black dark:text-white mb-2">
                    {t('webpricing.business.custom.title')}
                  </h4>
                  <p className="text-primary font-bold text-lg">{t('webpricing.business.pricebscustom')}</p>
                </div>
              </div>
...
<div className="border-t border-stroke dark:border-strokedark mt-6 pt-6 pb-8">
  <h4 className="font-semibold text-black dark:text-white mb-4">
    {t('webpricing.business.features.title')}
  </h4>
  <ul className="space-y-3">
    {(t('webpricing.business.features.list', { returnObjects: true }) as string[]).map((feature, index) => (
      <li key={index} className="flex items-start gap-3 text-black dark:text-manatee">
        <svg className="w-5 h-5 text-meta mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" />
        </svg>
        {feature}
            ...
            <div className="animate_top md:w-[45%] lg:w-1/3 group relative bg-white dark:bg-blacksection rounded-lg shadow-solid-10 dark:shadow-none border border-stroke dark:border-strokedark p-7.5 xl:p-12.5">
              <h3 className="text-black dark:text-white font-bold text-2xl xl:text-3xl mb-2.5">
                {t('webpricing.ecommerce.title')}
              </h3>
              <p className="mb-6">{t('webpricing.ecommerce.description')}</p>
              
              <div className="flex gap-4 mb-6">
                <div className="w-1/2 bg-gray-2 dark:bg-black rounded-lg p-4">
                  <h4 className="font-semibold text-black dark:text-white mb-2">
                    {t('webpricing.ecommerce.theme.title')}
                  </h4>
                  <p className="text-primary font-bold text-lg">{t('webpricing.ecommerce.priceecomtheme')}</p>

                </div>
                <div className="w-1/2 bg-meta/5 rounded-lg p-4">
                  <h4 className="font-semibold text-black dark:text-white mb-2">
                    {t('webpricing.ecommerce.custom.title')}
                  </h4>
                  <p className="text-primary font-bold text-lg">{t('webpricing.ecommerce.priceecomcustom')}</p>
...
<div className="border-t border-stroke dark:border-strokedark mt-6 pt-6 pb-8">
  <h4 className="font-semibold text-black dark:text-white mb-4">
    {t('webpricing.ecommerce.features.title')}
  </h4>
  <ul className="space-y-3">
    {(t('webpricing.ecommerce.features.list', { returnObjects: true }) as string[]).map((feature, index) => (
      <li key={index} className="flex items-start gap-3 text-black dark:text-manatee">
        <svg className="w-5 h-5 text-meta mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" />
        </svg>
