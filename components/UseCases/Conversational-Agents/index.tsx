...
const UseCase: React.FC<UseCaseProps> = ({
    ...
    subtitle = "Enhance customer experience with intelligent, 24/7 automated support."
}) => {
                    ...
                    <aside className="hidden lg:block w-64 shrink-0">
                        <div className="sticky top-24 space-y-8">
                            ...
                            <div className="p-6 rounded-2xl bg-gradient-to-br from-purple-600 to-blue-600 text-white shadow-xl">
                                ...
                                <p className="text-white/80 text-sm mb-4">Get a custom AI agent tailored to your business needs.</p>
                            ...
                            <div className="grid md:grid-cols-2 gap-6">
                                {[1, 2, 3, 4].map((i) => (
                                    <div key={i} className="p-6 rounded-2xl bg-white dark:bg-white/5 border border-gray-100 dark:border-white/5 hover:border-purple-500/50 transition-colors shadow-lg shadow-gray-200/50 dark:shadow-none">
                                        ...
                                        <h3 className="text-xl font-bold mb-3">Feature Title {i}</h3>
                                        <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                                            Detailed explanation of this feature. How it integrates with the workflow and provides value to the end user.
                                        </p>
                                    </div>
                                ))}
                            </div>
                        ...
                        <section id="integration" className="mb-20 scroll-mt-24">
                            <div className="bg-gray-50 dark:bg-white/5 rounded-3xl p-8 md:p-12 border border-gray-100 dark:border-white/5">
                                ...
                                <p className="text-lg text-gray-600 dark:text-gray-300 mb-8 max-w-2xl">
                                    Connects deeply with your existing stack. Whether it's CRM, Database, or Front-end framework.
                                </p>
                                ...
                                <div className="relative rounded-xl overflow-hidden bg-[#1e1e1e] p-4 font-mono text-sm text-gray-300 shadow-inner">
                                    <div className="flex items-center gap-2 mb-4 opacity-50">
                                        ...
                                        <span className="ml-2 text-xs">install-agent.sh</span>
                                    </div>
                                    <div className="space-y-2">
                                        <p><span className="text-pink-500">$</span> npm install @ainsider/agent-core</p>
                                        <p><span className="text-pink-500">$</span> npx ainsider init --key=YOUR_API_KEY</p>
                                        <p className="text-green-400">✓ Agent initialized successfully</p>
                                    </div>
                                </div>
                            </div>
                        </section>
                                ...
                                {[1, 2, 3].map(i => (
                                    <details key={i} className="group p-6 rounded-2xl bg-white dark:bg-white/5 border border-gray-100 dark:border-white/5 open:ring-1 open:ring-purple-500/20">
                                        ...
                                        <p className="mt-4 text-gray-600 dark:text-gray-400 leading-relaxed">
                                            Our pricing is flexible and based on your usage. We offer tiered plans for startups, growth-stage companies, and enterprises. Contact sales for a custom quote.
                                        </p>
                                    </details>
                                ))}
                            </div>
