...
const featuresTabData: FeatureTab[] = [
  {
    id: "tabOne",
    title: t('SupportBotFeaturesTab.tab1Title'),
    desc1: t('SupportBotFeaturesTab.tab1Description1'),
    desc2: t('SupportBotFeaturesTab.tab1Description2'),
    image: "/images/features/undraw_business_decisions.svg",
    imageDark: "/images/features/undraw_business_decisions.svg",
  },
  {
    id: "tabTwo",
    title: t('SupportBotFeaturesTab.tab2Title'),
    desc1: t('SupportBotFeaturesTab.tab2Description1'),
    desc2: t('SupportBotFeaturesTab.tab2Description2'),
    image: "/images/features/undraw_chat.svg",
    imageDark: "/images/features/undraw_chat.svg",
  },
  {
    id: "tabThree",
    title: t('SupportBotFeaturesTab.tab3Title'),
    desc1: t('SupportBotFeaturesTab.tab3Description1'),
    desc2: t('SupportBotFeaturesTab.tab3Description2'),
