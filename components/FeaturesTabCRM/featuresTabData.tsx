...
const featuresTabData: FeatureTab[] = [
  {
    id: "tabOne",
    title: t('crmFeaturesTab.tab1Title'),
    desc1: t('crmFeaturesTab.tab1Description1'),
    desc2: t('crmFeaturesTab.tab1Description2'),
    image: "/images/features/undraw_marketing.svg",
    imageDark: "/images/features/undraw_marketing.svg",
  },
  {
    id: "tabTwo",
    title: t('crmFeaturesTab.tab2Title'),
    desc1: t('crmFeaturesTab.tab2Description1'),
    desc2: t('crmFeaturesTab.tab2Description2'),
    image: "/images/features/undraw_status_update.svg",
    imageDark: "/images/features/undraw_status_update.svg",
  },
  {
    id: "tabThree",
    title: t('crmFeaturesTab.tab3Title'),
    desc1: t('crmFeaturesTab.tab3Description1'),
    desc2: t('crmFeaturesTab.tab3Description2'),
