  ...
  const timelineSteps: TimelineStep[] = [
    {
      ...
      description1: t('serviceTimeline.step1.description1'),
      description2: t('serviceTimeline.step1.description2'),
      description3: t('serviceTimeline.step1.description3'),
    ...
    },
    {
      ...
      description1: t('serviceTimeline.step2.description1'),
      description2: t('serviceTimeline.step2.description2'),
      description3: t('serviceTimeline.step2.description3'),
    ...
    },
    {
      ...
      description1: t('serviceTimeline.step3.description1'),
      description2: t('serviceTimeline.step3.description2'),
      description3: t('serviceTimeline.step3.description3'),
    ...
    },
    {
      ...
      description1: t('serviceTimeline.step4.description1'),
      description2: t('serviceTimeline.step4.description2'),
      description3: t('serviceTimeline.step4.description3'),
      image: "/images/features/undraw_solution_mindset.svg",
      imageDark: "/images/features/undraw_solution_mindset.svg",
    },
  ];
              ...
              >
                ...
                <div className={`flex flex-col md:flex-row ${index % 2 === 0 ? 'md:flex-row-reverse' : ''}`}>
                  <div className="md:w-1/2 pl-14 md:pl-0 md:pr-8 md:text-right mb-8 md:mb-0">
                    ...
                    <h3 className="text-black dark:text-white text-xl xl:text-2xl font-bold mb-3">{step.title}</h3>
                    <ul className="list-disc pl-5 text-body-color dark:text-body-color-dark space-y-2">
                    <p className="text-body-color dark:text-body-color-dark">{step.description1}</p>
                    <p className="text-body-color dark:text-body-color-dark">{step.description2}</p>
                    <p className="text-body-color dark:text-body-color-dark">{step.description3}</p>
                    </ul>
                  </div>
