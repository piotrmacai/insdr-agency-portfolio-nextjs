    ...
    <>
      ...
      <section className="py-10 lg:py-15 xl:py-20 mb-8 overflow-hidden">
        ...
        <div className="mx-auto max-w-c-1235 px-4 md:px-8 xl:px-0">
             <SectionHeader
              headerInfo={{
                title: t('businesswebabout.title'),
                subtitle: t('businesswebabout.subtitle1'),
                description: t('businesswebabout.subtitle2'),
              }}
            />
            ...
            >
              <h4 className="text-black dark:text-white font-medium uppercase">
                <span className="bg-meta text-white text-metatitle inline-flex rounded-full py-1 px-4.5 mr-4 mb-4 uppercase">
                  {t('businesswebabout.section1.header1')}
                </span>{" "}
                {/* {t('webabout.section1.header2')} */}
              </h4>
              <h2 className="relative font-bold text-black dark:text-white text-3xl mb-6">
                ...
                <span className="inline-block relative before:absolute before:bottom-2.5 before:left-0 before:w-full before:h-3 before:bg-titlebg dark:before:bg-titlebgdark before:-z-1">
                  {/* {t('webabout.section1.header4')} */}
                </span>
              </h2>
              <p className="mb-8 text-lg">
                {t('businesswebabout.section1.desc1')}
              </p>
              ...
              <div className="mt-7.5 flex items-center gap-5">
                ...
                <div className="w-3/5">
                  ...
                  {t('businesswebabout.section1.desc2')}
                  </h5>
                  <p>{t('businesswebabout.section1.desc3')}</p>
                </div>
              </div>
              ...
              <div className="mt-7.5 flex items-center gap-5">
                ...
                <div className="w-3/5">
                  <h5 className="text-black dark:text-white text-metatitle2 mb-0.5">
                    {t('businesswebabout.section1.desc4')}
                  </h5>
                  <p>{t('businesswebabout.section1.desc5')} </p>
                </div>
              </div>
            </motion.div>
          </div>
      ...
      <section className="hidden md:flex">
        <div className="mx-auto max-w-c-1235 px-4 md:px-8 2xl:px-0 overflow-hidden">
          <div className="flex items-center gap-8 lg:gap-32.5">
            ...
            >
              <h4 className="text-black dark:text-white font-medium uppercase">
                {t('businesswebabout.section2.header1')}
              </h4>
              <h2 className="relative font-bold text-black dark:text-white text-3xl mb-6">
                {t('businesswebabout.section2.header2')}
              </h2>
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h5 className="text-lg font-semibold mb-2">{t('businesswebabout.section2.desc2')}</h5>
                    <p>{t('businesswebabout.section2.desc1')}</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h5 className="text-lg font-semibold mb-2">{t('businesswebabout.section2.header3')}</h5>
                    <p>{t('businesswebabout.section2.desc2')}</p>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                >
                  <span className="hover:pr-2 duration-500">{t('businesswebabout.section2.button')}</span>
                  <svg
                    width="14"
                    height="14"
                    viewBox="0 0 14 14"
        ...
        <div className="mx-auto max-w-c-1235 px-4 md:px-8 xl:px-0">
          <div className="flex items-center gap-8 lg:gap-32.5">
            ...
            >
                  <h4 className="text-black dark:text-white font-medium uppercase">
                <span className="bg-meta text-white text-metatitle inline-flex rounded-full py-1 px-4.5 mr-4 mb-4 uppercase">
                  {t('businesswebabout.section3.header1')}
                </span>{" "}
                {/* {t('webabout.section3.header2')} */}
              </h4>
              <h2 className="relative font-bold text-black dark:text-white text-3xl mb-6">
                {t('businesswebabout.section3.header2')}
              </h2>
              <p className="mb-8 text-lg">
                {t('businesswebabout.section3.desc1')}
              </p>
              ...
              <div className="mt-7.5 flex items-center gap-5">
                ...
                <div className="w-3/5">
                  <h5 className="text-black dark:text-white text-metatitle2 mb-0.5">
                  {t('businesswebabout.section3.header3')}
                  </h5>
                  <p>{t('businesswebabout.section3.desc3')}</p>
                </div>
              </div>
              ...
              <div className="mt-7.5 flex items-center gap-5">
                ...
                <div className="w-3/5">
                  <h5 className="text-black dark:text-white text-metatitle2 mb-0.5">
                  {t('businesswebabout.section3.header4')}
                  </h5>
                  <p>{t('businesswebabout.section3.desc4')}</p>
                </div>
              </div>
            </motion.div>
          </div>
        ...
        <div className="mx-auto max-w-c-1235 px-4 md:px-8 2xl:px-0 overflow-hidden">
          <div className="flex items-center gap-8 lg:gap-32.5 md:pr-4">
            ...
            >
                <h4 className="text-black dark:text-white font-medium uppercase">
                <span className="bg-meta text-white text-metatitle inline-flex rounded-full py-1 px-4.5 mr-4 mb-4 uppercase">
                  {t('businesswebabout.section4.header1')}
                </span>{" "}
                {/* {t('webabout.section4.desc1')} */}
              </h4>
              <h2 className="relative font-bold text-black dark:text-white text-3xl mb-6">
                {t('businesswebabout.section4.header2')}
              </h2>
              <p className="mb-8 text-lg">
                {t('businesswebabout.section4.desc1')}
              </p>
              <p className="mb-8 text-lg">
                {t('businesswebabout.section4.desc2')}
              </p>
              ...
              <div>
                <a
                  ...
                  className="flex items-center gap-2.5 text-black dark:text-white mt-7.5 hover:text-primary dark:hover:text-primary"
                >
                  <span className="hover:pr-2 duration-500">{t('businesswebabout.section4.button')}</span>
                  <svg
                    width="14"
                    height="14"
                    viewBox="0 0 14 14"
...
export default BusinesswebAbout;
