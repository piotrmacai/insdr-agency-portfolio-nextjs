    ...
    <>
      ...
      <section className="py-10 lg:py-15 xl:py-20 mb-8 overflow-hidden">
        ...
        <div className="mx-auto max-w-c-1235 px-4 md:px-8 xl:px-0">
             <SectionHeader
              headerInfo={{
                title: t('webabout.title'),
                subtitle: t('webabout.subtitle1'),
                description: t('webabout.subtitle2'),
              }}
            />
            ...
            >
              ...
              <div className="mt-7.5 flex items-center gap-5">
                ...
                <div className="w-3/5">
                  ...
                  {t('webabout.section1.desc2')}
                  </h5>
                  <p>{t('webabout.section1.desc3')}</p>
                </div>
              </div>
              ...
              <div className="mt-7.5 flex items-center gap-5">
                ...
                <div className="w-3/5">
                  <h5 className="text-black dark:text-white text-metatitle2 mb-0.5">
                    {t('webabout.section1.desc4')}
                  </h5>
                  <p>{t('webabout.section1.desc5')} </p>
                </div>
              </div>
            </motion.div>
          </div>
      ...
      <section className="hidden md:flex">
        <div className="mx-auto max-w-c-1235 px-4 md:px-8 2xl:px-0 overflow-hidden">
          <div className="flex items-center gap-8 lg:gap-32.5">
            ...
            >
              <h4 className="text-black dark:text-white font-medium uppercase">
                {t('webabout.section2.header1')}
              </h4>
              <h2 className="relative font-bold text-black dark:text-white text-3xl mb-6">
                {t('webabout.section2.header2')}
              </h2>
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h5 className="text-lg font-semibold mb-2">{t('webabout.section2.desc2')}</h5>
                    <p>{t('webabout.section2.desc1')}</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h5 className="text-lg font-semibold mb-2">{t('webabout.section2.header3')}</h5>
                    <p>{t('webabout.section2.desc2')}</p>
                  </div>
                </div>
              </div>
          ...
          <div className="flex items-center gap-8 lg:gap-32.5">
            ...
            >
              ...
              <div className="mt-7.5 flex items-center gap-5">
                ...
                <div className="w-3/5">
                  <h5 className="text-black dark:text-white text-metatitle2 mb-0.5">
                  {t('webabout.section3.header3')}
                  </h5>
                  <p>{t('webabout.section3.desc3')}</p>
                </div>
              </div>
              ...
              <div className="mt-7.5 flex items-center gap-5">
                ...
                <div className="w-3/5">
                  <h5 className="text-black dark:text-white text-metatitle2 mb-0.5">
                  {t('webabout.section3.header4')}
                  </h5>
                  <p>{t('webabout.section3.desc4')}</p>
                </div>
              </div>
            </motion.div>
          </div>
        ...
        <div className="mx-auto max-w-c-1235 px-4 md:px-8 2xl:px-0 overflow-hidden">
          <div className="flex items-center gap-8 lg:gap-32.5 md:pr-4">
            ...
            >
                <h4 className="text-black dark:text-white font-medium uppercase">
                <span className="bg-meta text-white text-metatitle inline-flex rounded-full py-1 px-4.5 mr-4 mb-4 uppercase">
                  {t('webabout.section4.header1')}
                </span>{" "}
                {/* {t('webabout.section4.desc1')} */}
              </h4>
              <h2 className="relative font-bold text-black dark:text-white text-3xl mb-6">
                {t('webabout.section4.header2')}
              </h2>
              <p className="mb-8 text-lg">
                {t('webabout.section4.desc1')}
              </p>
              <p className="mb-8 text-lg">
                {t('webabout.section4.desc2')}
              </p>
