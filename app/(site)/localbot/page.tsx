...
{/* FIRST ROW */}       
  ...
  <div className="flex flex-col items-start rounded-xl border border-stroke dark:border-strokedark bg-white dark:bg-blacksection p-6 shadow-sm">
    ...
    <h3 className="mb-2 text-lg font-semibold text-black dark:text-white">
      {t('localbot.features.privacy.title')}
    </h3>
    <p className="text-sm text-gray-600 dark:text-gray-400">
      {t('localbot.features.privacy.desc')}
    </p>
  </div>
  ...
  <div className="flex flex-col items-start rounded-xl border border-stroke dark:border-strokedark bg-white dark:bg-blacksection p-6 shadow-sm">
    ...
    <h3 className="mb-2 text-lg font-semibold text-black dark:text-white">
      {t('localbot.features.personalization.title')}
    </h3>
    <p className="text-sm text-gray-600 dark:text-gray-400">
      {t('localbot.features.personalization.desc')}
    </p>
  </div>
  ...
  <div className="flex flex-col items-start rounded-xl border border-stroke dark:border-strokedark bg-white dark:bg-blacksection p-6 shadow-sm">
    ...
    <h3 className="mb-2 text-lg font-semibold text-black dark:text-white">
      {t('localbot.features.support.title')}
    </h3>
    <p className="text-sm text-gray-600 dark:text-gray-400">
      {t('localbot.features.support.desc')}
    </p>
  </div>
  ...
  <div className="flex flex-col items-start rounded-xl border border-stroke dark:border-strokedark bg-white dark:bg-blacksection p-6 shadow-sm">
    ...
    <h3 className="mb-2 text-lg font-semibold text-black dark:text-white">
      {t('localbot.features.integrations.title')}
    </h3>
    <p className="text-sm text-gray-600 dark:text-gray-400">
      {t('localbot.features.integrations.desc')}
    </p>
  </div>
  ...
  <div className="flex flex-col items-start rounded-xl border border-stroke dark:border-strokedark bg-white dark:bg-blacksection p-6 shadow-sm">
    ...
    <h3 className="mb-2 text-lg font-semibold text-black dark:text-white">
      {t('localbot.features.analytics.title')}
    </h3>
    <p className="text-sm text-gray-600 dark:text-gray-400">
      {t('localbot.features.analytics.desc')}
    </p>
  </div>
  ...
  <div className="flex flex-col items-start rounded-xl border border-stroke dark:border-strokedark bg-white dark:bg-blacksection p-6 shadow-sm">
    ...
    <h3 className="mb-2 text-lg font-semibold text-black dark:text-white">
      {t('localbot.features.installation.title')}
    </h3>
    <p className="text-sm text-gray-600 dark:text-gray-400">
      {t('localbot.features.installation.desc')}
    </p>
  </div>
</div>
